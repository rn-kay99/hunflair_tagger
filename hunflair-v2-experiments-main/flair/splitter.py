...
class GeneticVariantSentenceSplitter(SpacySentenceSplitter):
    """Sentence splitter using the spacy model `en_core_sci_sm`.
    ...
    def __init__(self) -> None:
        print("**** GeneticVariantSentenceSplitter ****")
        super().__init__("en_core_sci_sm", GeneticVariantTokenizer())
