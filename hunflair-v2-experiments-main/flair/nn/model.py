        ...
        **kwargs,
        ...
        with torch.no_grad():
            ...
            for batch in Tqdm.tqdm(loader):
                ...
                # print(f"*** new batch with length: {len(batch)} ***")
                # print("****************************")
                # get the gold labels
                print_counter_gold = 0
                print_counter_pred = 0

                for datapoint in batch:
                    # print("datapoint:")
                    # print(datapoint)
                    # print(datapoint.get_labels(gold_label_type))
                    # print(datapoint.get_labels("predicted"))
                    for gold_label in datapoint.get_labels(gold_label_type):
                        representation = str(sentence_id) + ": " + gold_label.unlabeled_identifier

                        # if print_counter_gold < 3:
                        #     print(f"*** {print_counter_gold}. gold_label representation ***")
                        #     print(representation)
                        #     print(gold_label.value)
                        #     print("****************************")
                        #     print_counter_gold += 1
                    ...
                    for predicted_span in datapoint.get_labels("predicted"):
                        ...
                        # if print_counter_pred < 3:
                        #     print(f"*** {print_counter_pred}. predicted_span representation ***")
                        #     print(representation)
                        #     print(predicted_span.value)
                        #     print("****************************")
                        #     print_counter_pred += 1
            ...
            true_values_span_print = [] # only for testing
            predicted_values_span_print = [] # only for testing
            # print(f"all spans (length {len(all_spans)}):")
            # print(all_spans)
            # print()
            for span in all_spans:
                ...
                true_values_span_print.append(span) # only for testing
        ...
        # print("spans for values:")
        # print(true_values_span_print)
        # print(f"*** true_values_span_aligned {len(true_values_span_aligned)}***")
        # print(true_values_span_aligned)
        # print("****************************")

        # print(f"*** predicted_values_span_aligned {len(predicted_values_span_aligned)}***")
        # print(predicted_values_span_aligned)
        # print("****************************")
