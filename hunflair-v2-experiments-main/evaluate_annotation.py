        ...
        for annotation in document.annotations:
            ...
            if mention_text != span_text:
                ...
                if mention_text == span_text:
                    ...
                    print(f"Incorrect span: |{mention_text}| vs. |{span_text}|")
                    false_spans += 1
...
if __name__ == "__main__":
    ...
    print(f"Ignore normalization IDs: {ignore_normalization}")
    exact_results = {}
    partial_results = {}
    entity_types = None
    ...
    for pred_file in args.pred_files:
        ...
        # exact_result = evaluate(args.gold_file, pred_file, partial_match(0), ignore_normalization)
